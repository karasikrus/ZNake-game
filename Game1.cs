...
namespace Game1
{
    ...
    public class Game1 : Game
    {
        ...
        SoundEffectInstance death2Instance;
     ...
     //   private bool gui_rectangle_checkmouse(Rectangle rct)
        ...
        private void init_menu()
        {
            ...
            death2 = Content.Load<SoundEffect>("snaaaaaake");
        ...
        private void draw_game()
        {
            ...
            if (_gameState == GameStates.Dead)
            {
                ...
                spriteBatch.DrawString(spritefont, "your final score is "+ score*DIFMLT, new Vector2(window_width / 3, window_height / 3), Color.White, 0, new Vector2(0, 0), 2.0f, SpriteEffects.None, 0f);
            }
...
spriteBatch.DrawString(spritefont, "Score: "+score, new Vector2(0,0), Color.White);
        ...
        protected override void Update(GameTime gameTime)//хелп
        {
            ...
            {
                keptyouwaitinghuh = false;
                d = rand.Next(1, 7);
                if (d == 3)
                    keptyouwaitinghuh = true;

                if (deathmusic == false)
                {
                    deathmusic = true;
                    if (keptyouwaitinghuh == false)
                    deathInstance.Play();
                    else
                        death2Instance.Play();
